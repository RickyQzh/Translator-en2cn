...
# 测试数据评估BLEU
test_data = TranslationDataset('./cmn-eng-simple/testing.txt', word2int_en, word2int_cn)
total_bleu = 0

for en, cn in test_data:
...
print(f'Test BLEU Score: {total_bleu / len(test_data):.4f}')
